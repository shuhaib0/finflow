    ...
    <div className="bg-white text-gray-900 font-sans a4-container printable-area">
      <header className="flex justify-between items-start mb-10">
        ...
        <div className="text-right">
          <h2 className="text-3xl font-bold text-gray-800 uppercase font-headline">Quotation</h2>
          <p className="text-sm text-gray-600 mt-1"># {quotationNumber || 'QUO-XXXX'}</p>
          <div className="mt-4">
      ...
      <section className="grid grid-cols-2 gap-4 mb-10">
        ...
        <div className="text-right">
          <div className="mb-2">
            <p className="text-xs font-semibold uppercase text-gray-500 tracking-wider">Quotation Date</p>
            <p className="text-sm font-medium">{format(new Date(date), "MMMM d, yyyy")}</p>
          </div>
          <div>
            <p className="text-xs font-semibold uppercase text-gray-500 tracking-wider">Expires On</p>
